...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Dubai Tour Packages Section */}
      <section className="pt-8 pb-20 bg-white">
        <div className="container mx-auto px-4">
          <div
            ref={domesticPackagesAnimation.ref}
            className={`text-center mb-12 transition-all duration-1000 ease-out ${domesticPackagesAnimation.isVisible
              ? 'opacity-100 translate-y-0'
              : 'opacity-0 translate-y-10'
              }`}
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-gray-900 px-4">Dubai Tour Packages - Featured Experiences with Featured Dubai Tours</h2>
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
              Discover the magic of Dubai with our carefully crafted tour packages. From luxury experiences to budget-friendly adventures, explore the best of Dubai's iconic landmarks, desert safaris, and world-class attractions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-12 px-4">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm rounded-b-lg p-3">
                ...
                <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1 uppercase leading-tight">
                  Dubai City Tour - Burj Khalifa & Dubai Mall Experience
                </h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-2">
                  Burj Khalifa, Dubai Mall, Dubai Fountain, Palm Jumeirah & Marina
                </p>
                <div className="text-sm sm:text-base text-gray-700 font-medium">
                  1 Day • Starting from AED 5,500
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm rounded-b-lg p-3">
                ...
                <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1 uppercase leading-tight">
                  Dubai Desert Safari with BBQ Dinner & Entertainment
                </h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-2">
                  Dune Bashing, Camel Ride, Belly Dance, BBQ Dinner & Traditional Shows
                </p>
                <div className="text-sm sm:text-base text-gray-700 font-medium">
                  Half Day • Starting from AED 2,500
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm rounded-b-lg p-3">
                ...
                <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1 uppercase leading-tight">
                  Abu Dhabi Day Tour - Sheikh Zayed Mosque & Louvre
                </h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-2">
                  Sheikh Zayed Grand Mosque, Louvre Abu Dhabi & Emirates Palace
                </p>
                <div className="text-sm sm:text-base text-gray-700 font-medium">
                  1 Day • Starting from AED 4,500
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div
            ...
            className={`text-center mb-12 transition-all duration-1000 ease-out ${luxuryPackagesAnimation.isVisible
              ? 'opacity-100 translate-y-0'
              : 'opacity-0 translate-y-10'
              }`}
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-gray-900 px-4">Dubai Tour Packages - Premium Experiences with Premium Dubai Tours</h2>
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
              Indulge in the ultimate Arabian opulence with our exclusive luxury collection. From private yacht cruises to royal desert retreats and 7-star hospitality, experience Dubai at its most magnificent.
            </p>
          </div>

          {/* Luxury Package Cards */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-12 px-4">
            {/* Private Yacht & Burj Al Arab Experience */}
            <div
              className="relative rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer"
              onClick={() => router.push('/packages')}
            >
              <img
                src="https://images.unsplash.com/photo-1544913776-90c1223073a3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                alt="Luxury Yacht Dubai"
                className="w-full h-80 object-cover"
              />
              {/* Overlay Content Box */}
              <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm rounded-b-lg p-3">
                ...
                <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1 uppercase leading-tight">
                  Royal Yacht Cruise & Burj Al Arab Dining
                </h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-2">
                  Private Yacht, 24k Gold Afternoon Tea, Rolls Royce Transfers
                </p>
                <div className="text-sm sm:text-base text-gray-700 font-medium">
                  Full Day • Starting from AED 15,000
                </div>
              </div>
            </div>

            {/* Premium Desert Resort Stay */}
            <div
              className="relative rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer"
              onClick={() => router.push('/packages')}
            >
              <img
                src="https://images.unsplash.com/photo-1451337516015-fabf09175402?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
                alt="Al Maha Desert Resort"
                className="w-full h-80 object-cover"
              />
              {/* Overlay Content Box */}
              <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm rounded-b-lg p-3">
                ...
                <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1 uppercase leading-tight">
                  Al Maha Desert Resort Luxury Escape
                </h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-2">
                  Private Pool Suite, Wildlife Safari, Spa Treatments & Fine Dining
                </p>
                <div className="text-sm sm:text-base text-gray-700 font-medium">
                  2 Days / 1 Night • Starting from AED 8,500
                </div>
              </div>
            </div>

            {/* Helicopter Tour & Palm Penthouse */}
            <div
              className="relative rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer"
              onClick={() => router.push('/packages')}
            >
              <img
                src="https://images.unsplash.com/photo-1526495124232-a02e18494d4a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm rounded-b-lg p-3">
                ...
                <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1 uppercase leading-tight">
                  Elite Helicopter Tour & Palm Penthouse Stay
                </h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-2">
                  Aerial Sightseeing, Private Chef Service, Luxury Penthouse on Palm Jumeirah
                </p>
                <div className="text-sm sm:text-base text-gray-700 font-medium">
                  3 Days / 2 Nights • Starting from AED 25,000
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            >
              ...
              Explore All Luxury Experiences
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div
            ...
            className={`text-center mb-12 transition-all duration-1000 ease-out ${internationalPackagesAnimation.isVisible
              ? 'opacity-100 translate-y-0'
              : 'opacity-0 translate-y-10'
              }`}
          >
            <h2 className="text-4xl font-bold mb-4 text-gray-900">Dubai Tour Packages - Luxury Experiences with Luxury Dubai Tours</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience the ultimate luxury and adventure in Dubai with our expertly curated tour packages. From iconic landmarks to thrilling desert safaris, discover why Dubai is the world's most visited destination.
            </p>
          </div>

          {/* International Package Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {/* Dubai Luxury Package */}
            <div
              className="relative rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer"
              onClick={() => router.push('/packages')}
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm rounded-b-lg p-3">
                ...
                <h3 className="text-sm font-bold text-gray-900 mb-1 uppercase">
                  Dubai 4 Nights 5 Days Luxury Package - Complete Dubai Experience
                </h3>
                <p className="text-xs text-gray-600 mb-2">
                  Burj Khalifa, Desert Safari, Abu Dhabi Tour, Dubai Marina & More
                </p>
                <div className="text-xs text-gray-700 font-medium">
                  4N/5D • Starting from AED 45,000
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm rounded-b-lg p-3">
                ...
                <h3 className="text-sm font-bold text-gray-900 mb-1 uppercase">
                  Dubai & Abu Dhabi 5 Nights 6 Days Premium Package
                </h3>
                <p className="text-xs text-gray-600 mb-2">
                  Complete UAE Experience - Dubai City Tour, Desert Safari, Abu Dhabi & Theme Parks
                </p>
                <div className="text-xs text-gray-700 font-medium">
                  5N/6D • Starting from AED 55,000
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm rounded-b-lg p-3">
                ...
                <h3 className="text-sm font-bold text-gray-900 mb-1 uppercase">
                  Dubai 7 Nights 8 Days Ultimate Luxury Package
                </h3>
                <p className="text-xs text-gray-600 mb-2">
                  Premium Dubai Experience - All Attractions, Desert Safari, Theme Parks & Shopping
                </p>
                <div className="text-xs text-gray-700 font-medium">
                  7N/8D • Starting from AED 75,000
                </div>
              </div>
            </div>
          </div>
